# Project Charta
## Context and Scope
This project focuses on the analysis of meteorite landings worldwide. Meteorites are classified based on their composition and recorded with attributes such as mass, location, and year of discovery.

The main goal is to explore patterns in meteorite distribution, size, and classification. The project aims to answer questions such as where meteorites most frequently land, how their mass varies, and which types are most common.
